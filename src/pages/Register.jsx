...
const Register = () => {
  ...
  // checking that use is already present
  useEffect(() => {
    const exitinguser = () => {
  ...
  const handlesubmit = (e) => {
    ...
    // storing user data on localstorage
  ...
  return (
    <div className="relative flex items-center justify-between w-full h-screen p-5">
            ...
            <div className="relative flex flex-col top-10 ">
              ...
              <div class="relative z-0 w-full mb-6 group">
                ...
                <input
                  ...
                  name="floating_email"
                  id="floating_email"
                  className="block py-2.5 text-center px-0 w-full text-base text-darkblue bg-transparent font-popin font-medium border-0 border-b-2 border-gray-500 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-darkblue peer placeholder:text-darkblue placeholder:text-base placeholder:font-popin  placeholder:font-medium "
              ...
              <div class="relative z-0 w-full mb-6 group">
                ...
                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <CiUser className="relative w-5 h-5 text-darkblue top-2 right-3" />
                </div>
                <input
                  type="text"
                  name="floating_email"
              ...
              <div class="relative z-0 w-full mb-6 group">
                ...
                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <svg
                    className="relative w-4 h-4 cursor-pointer text-darkblue top-3 left-60"
                    viewBox="0 0 14 14"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
              ...
              <div className="relative z-0 w-full mb-6 group">
                ...
                />
                 <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <svg
                    className="relative w-4 h-4 text-gray-900 cursor-pointer top-3 left-60"
                    viewBox="0 0 14 14"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
              ...
              <button
                type="submit"
                className="h-10 text-base font-medium text-white rounded-3xl hover:bg-opacity-90 bg-button font-popin"
              >
                Register
              </button>
            </div>
      ...
      {/* right */}
      <div className="relative flex flex-col items-center max-w-5xl min-h-full left-64 justify-items-center bg-darkblue rounded-2xl">
